    ...
    return Scaffold(body: SingleChildScrollView(
      child: Column(
        children: [
          ...
          GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>Idiomas()));
            },
            child: Container(
              height: 60,
              child: Column(
          ...
          GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>Politicas_uso()));
            },
            child: Container(
              height: 59,
              child: Column(
          ...
          GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>Cadastro_Loja()));
            },
            child: Container(
              height: 59,
              child: Column(
