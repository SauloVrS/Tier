...
import '../../views/pedidos_users/acompanhe_pedido.dart';


class Finalizados extends StatefulWidget {
  const Finalizados({Key? key}) : super(key: key);

  @override
  State<Finalizados> createState() => _FinalizadosState();
}

class _FinalizadosState extends State<Finalizados> {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: pedido.status == 'Finalizado'
            ? Row(
              children: [
                const Icon(
